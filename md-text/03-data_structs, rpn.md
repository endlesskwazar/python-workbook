...
Словацький Python, за більшою частиною, представляє собою хеш-таблицю. У деяких мовах словарі можуть використовуватись як асоціативна пам'ять, чи асоціативні массиви. Вони індексируються за допомогою ключів, які можуть бути будь-якими immutable типами. Наприклад, строка або число може бути ключем. Ви обов'язково зупиняєтеся на тому факті, що словник - це унікальний набір ключа: значення, а ключі обов'язково повинні бути унікальними.
