...
1. Переобіть розроблений RPN в 3-й лабораторній роботі із використанням ООП, так щоб продемонструквати інкапсуляцію, наслідування, поліморфізм.
2. Напишіть на розроблений RPN 100% модульних тестів.
